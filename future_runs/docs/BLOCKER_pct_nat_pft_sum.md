...
3. 重新提交 6 个 case（job 549473/549474/549476/549477/549479/549481），
   ...
   截至 2026-09-21 09:39 进度 46-55/77 年，仍在自动续投中。

**2026-09-21 17:40，最终确认：6 个 case 全部跑完。** 77/77 个 h0 文件、
均已写出 `*.cpl.r.2101-01-01-00000.nc` 收尾 restart，squeue 队列清空，
每个 case 最后一段的 `e3sm.log` 里 ERROR/ENDRUN/Segmentation 命中数均为 0。
这个 bug 到此彻底解决，不留尾巴。
